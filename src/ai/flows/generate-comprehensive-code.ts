...
export async function generateComprehensiveCode(input: GenerateComprehensiveCodeInput): Promise<GenerateComprehensiveCodeOutput> {
  return generateComprehensiveCodeFlow(input);
}

const generateComprehensiveCodeFlow = ai.defineFlow(
  {
    name: 'generateComprehensiveCodeFlow',
    inputSchema: GenerateComprehensiveCodeInputSchema,
    outputSchema: GenerateComprehensiveCodeOutputSchema,
  },
  async (input) => {
